...
function StandUpscheduler(hour,min,channelNames,client){
    console.log('inside standp');
    schedule.scheduleJob(`${min} ${hour} * * *`, function(){ // set time for standup more on https://www.npmjs.com/package/node-schedule
